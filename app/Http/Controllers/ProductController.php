...
class ProductController extends Controller
{
    ...
    public function add_product(){
    	...
    	return view('admin.add_product')->with('cate_product', $cate_product)->with('author', $author);
    ...
    public function save_product(Request $request){
    	...
    	$data['product_numberOfPages'] = $request->product_numberOfPages;
    	...
    	if($get_image){
	    	...
	    	Session::put('message','Thêm đầu sách mới thành công');
    ...
    public function edit_product($id){
    	...
    	$manager_product = view('admin.edit_product')->with('edit_product', $edit_product)->with('cate_product', $cate_product)->with('author', $author);
    ...
    public function show_product_detail($id){
        ...
        ->join('tbl_category_product','tbl_category_product.category_id','=', 'tbl_product.category_id')
        ->join('tbl_author','tbl_author.author_id','=', 'tbl_product.author_id')
        ->where('tbl_category_product.category_id', $cateid)->whereNotIn('tbl_product.product_id', [$id])->limit(3)->get();

        return view('pages.product.show_details')->with('cate_product', $cate_product)->with('author', $author)->with('product_details', $details_product)->with('related_product', $related_product)->with('banchay_product', $SpBanChayNhat);
    }
}
